...
- Create two databases in MariaDB, **these need to be using UTF8-based collation (utf8mb4_unicode_ci or similar)**:
...
- Run these commands in the same terminal window:
  1. `node db/populateTables.js`
  2. `node db/addData.js`
